...
static void generate(int left, int top)
{
	...
	ccnGenerateValueNoise(&noise, seed, CCN_FLAG_TILE_HORIZONTAL | CCN_FLAG_TILE_VERTICAL, CCN_MAXPERIOD, CCN_MAXPERIOD, left?0:1, top?0:1, WIDTH, HEIGHT, 1, 64, CCN_INTERP_CUBIC);
